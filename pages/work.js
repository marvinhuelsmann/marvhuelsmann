            ...
            <main className={"mb-10"}>
                <div
                    ...
                    <div className="xl:mt-48 mt-12 mb-4">
                        ...
                        >
                            <span
                                className={"flex text-black xl:text-3xl md:text-2xl text-xl text-left justify-left"}>{t('work.definitely.text.1')} <span className={"underline decoration-orange-400/30 xl:pl-2 xl:pr-2 pr-1 pl-1"}>{t('work.definitely.text.2')}</span> {t('work.definitely.text.3')}
                            </span>
                ...
                <div className={"justify-center bg-black bg-blend-color-dodge"}>
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <h1 className={"xl:text-8xl text-6xl font-bold flex justify-center items-center text-center text-black mx-auto"}>
                                {t('work.why')}
                            </h1>
                            <p className={"pt-2 flex xl:text-5xl md:text-4xl text-3xl justify-center text-center mx-auto text-black"}>
                                {t('work.why.text.1')}<br className={"xl:block md:block hidden"}/> {t('work.why.text.2')}
                            </p>
